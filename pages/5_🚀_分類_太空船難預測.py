...
st.title('太空船難預測')
#太空船難檢測參數
HomePlanet = st.slider('Cabin_region1:', min_value=0, max_value=1, value=0.0)
CryoSleep = st.slider('Cabin_region1:', min_value=0, max_value=1, value=0.0)
Destination = st.slider('Cabin_region1:', min_value=0, max_value=1, value=0.0)
Age = st.slider('age:', min_value=0, max_value=79, value=18.0)
VIP = st.slider('Cabin_region1:', min_value=0, max_value=1, value=0.0)
...
Cabin_deck = st.slider('Cabin_region1:', min_value=0, max_value=1, value=0.0)
Cabin_side = st.slider('Cabin_region1:', min_value=0, max_value=1, value=0.0)
